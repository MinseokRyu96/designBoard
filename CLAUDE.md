...
**새 기능 추가·수정·버그 수정 시 README.md를 반드시 함께 업데이트할 것.**

- 새 UX 기능 → `## UX 기능 상세` 해당 섹션 표에 행 추가
- 새 핵심 기능 → `## 핵심 기능` 표에 행 추가
- 버그 수정은 별도 기록 불필요, 기능 설명만 최신 상태 유지
- 공유 유틸(`src/lib/`) 파일 추가 시 파일 구조 규칙 업데이트
